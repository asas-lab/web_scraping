...
# Set the save rate for saving data to json file
save_rate = 10
...
json_data_file_path = f'{current_path}\aitnews.json'
...
for i in range(1, latest_page_number):
    ...
    try:
        ...
        # Save the DataFrame to json file at the specified save rate
        if i % save_rate == 0:
